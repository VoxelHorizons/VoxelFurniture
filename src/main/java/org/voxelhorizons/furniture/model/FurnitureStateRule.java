...
public final class FurnitureStateRule {
    ...
    public enum NeighborFacing {
        ANY, SAME, SAME_OR_CORNER, PERPENDICULAR, CLOCKWISE, COUNTERCLOCKWISE, OPPOSITE;
        ...
        public static NeighborFacing parse(Object raw, boolean alignedOnly) {
            ...
            try { return valueOf(value); }
                ...
                throw new IllegalArgumentException("neighbor_facing must be ANY, SAME, SAME_OR_CORNER, PERPENDICULAR, CLOCKWISE, COUNTERCLOCKWISE or OPPOSITE");
            }
        }
    }
